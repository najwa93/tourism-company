    ...
    <div class="modal fade" id="myModal" role="dialog" style="margin-top: 40px;">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="col-md-6 col-xs-12" style="float: right; padding-right: 30px;"> <img src={{asset("images")}}  alt="human" style="width:200px;height: 200px;"></div>
            </div>   </form>
<hr>
            ...
            <div id="hotel" class="tabcontent row" style="display: all;">
                ...
                <div class="row">
                    <div class="col-md-6 col-xs-12" style="float: right;">
                        ...
                        <input type="number" class="form-control" id="usrname" placeholder="ادخـل  عـدد الليـالـي ..">
                    </div>
                    <div class="col-md-6 col-xs-12" style="float: right;">
                        <label style="color:#64AEF7;"><span class="glyphicon glyphicon-user" style="color: orange;"></span>&nbsp;عـدد الأشـخاص  </label>
                        <input type="number" class="form-control" id="usrname" placeholder="ادخـل  عـدد المسـافرين ..">
                    </div></div>
                <button type="button" class="btn btn-info" style="color: white; width: 120px;height: 35px; font-size: 20px; margin-top: 10px;"><span class="glyphicon glyphicon-search" style="color: orange;"></span>&nbsp;بـحـث</button><br>
            </div>
            ...
            <div id="flight" class="tabcontent row" style="display: none;">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-xs-12" style="float: right; padding-top: 33px;">
                        <button type="button" class="btn btn-info" style="color: white; width: 120px;height: 34px; font-size: 20px; "><span class="glyphicon glyphicon-search" style="color: orange;"></span>&nbsp;بـحـث</button></div></div>
            </div>
            ...
            <div id="offer" class="tabcontent row" style="display: none;">
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <input  type="text" class="form-control" id="myInput" onkeyup="myFunction()" placeholder="الـبـحـث بـاسـم المدينـة...."  style="text-align: right;">
                    </div>
                </div><br>
...
<!-- Wrapper for slides -->
<!--<div>
  <img clasimagesla" src="image/latravel1.jpg" width="100%" alt="latravel1">
</div>
     <section
