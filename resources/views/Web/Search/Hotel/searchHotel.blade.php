            ...
            <table class="table table-striped">
                ...
                @foreach($hotel_data as $hotel)
                    <tr>
                        ...
                        <th scope="col"><a href="{{route('hotelDetails',$hotel['room_id'])}}"> <button type="submit" class="btn btn-warning" style="color: white; width: 120px;height: 35px; font-size: 20px;padding: 4px ">&nbsp;التفاصيل</button></a><br>
                    </tr>
                @endforeach
                </tbody>
            </table>
