...
<div class="container">
    ...
    <div class="row">
        ...
        <div class=" col-md-4 col-xs-12" style="float: right;"><a href="{{route('Offers.create')}}"><button class="btn success"><span class="glyphicon glyphicon-gift"></span><br>العروض السياحية</button></a></div>
