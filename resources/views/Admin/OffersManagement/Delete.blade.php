...
@section('content')
    <div class="p1"><label
                style="font-size: 40px; margin-top:9%; color: white; font-weight: bold; margin-right: 12%;"><span
                    class="glyphicon glyphicon-gift" style="color:#f73917;"></span>&nbsp;حـذف عرض سـياحـي</label>
    </div>
    <br>
    <div class="well" style="font-size: 30px;font-weight: bold; color: #64AEF7; text-align: center;">&nbsp;<p style="color:#f73917;">هل تريد بالتأكيد القيام بعملية حذف عرض سياحي ؟</p>
    </div><br>
