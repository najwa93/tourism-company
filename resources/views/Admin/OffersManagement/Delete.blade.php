...
@section('content')
    ...
    color:#f73917; font-weight: bold;"><span class="glyphicon glyphicon-remove" style="color:#f73917;"></span>&nbsp;
            ...
            <br>
            <br>
            <form action="{{route('Offers.destroy',$editedOffer->id)}}" method="post">
                {{csrf_field()}}
                @method('DELETE')
                <div class="container" style="font-size: 18px;">
                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        <tr>
                            ...
                            <td class="text-center col-xs-4"
                                style="font-size: 20px;width: 200px; color: white; background-color: #64AEF7;">من
                                المدينة
                            </td>
                            <td class="text-center col-xs-4"
                                style="font-size: 20px;width: 200px; color: white; background-color: #64AEF7;">إلى
                                المدينة
                            </td>
                            <td class="text-center col-xs-4"
                            ...
                            <td class="text-center col-xs-4"
                                style="font-size: 20px;width: 200px; color: white; background-color: #64AEF7;">شركة
                                الطيران
                            </td>
                            <td class="text-center col-xs-4"
                                style="font-size: 20px;width: 200px; color: white; background-color: #64AEF7;">عدد
                                المقاعد
                                اقتصادية
                            </td>
                            <td class="text-center col-xs-4"
                            ...
                            <td class="text-center col-xs-4"
                                style="font-size: 20px;width: 200px; color: white; background-color: #64AEF7;">
                                سعرالتذكرة
                                الاقتصادية
                            </td>
                            <td class="text-center col-xs-4"
                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        @foreach($allData as $value)
                            <tr>
                                <td><input type="radio" name="returned_flight" checked
                                           value="{{$value['returned_flight_id']}}"></td>
                    ...
                    <div class="row" style="font-size: 25px;">
                        ...
                        <div class="col-md-6 col-xs-12" style="margin-top: 10px;">
                            <label style="color:#64AEF7;"><span class="glyphicon glyphicon-gift"
                                                                style="color: orange;"></span>&nbsp;مدة
                                العرض </label><br>
                ...
                <div class="container" style="font-size: 18px;">
                    ...
                    <div style="text-align: center; color:#64AEF7; font-size: 28px;"><label>قـائـمـة الفـنـادق</label>
                    </div>
                    <table class="table table-striped table-bordered">
                        <thead>
                        <tr>
                            ...
                            <td class="text-center col-xs-4"
                                style="font-size: 20px;width: 200px; color: white; background-color: #64AEF7;">اسم
                                الغرفة
                            </td>
                            <td class="text-center col-xs-4"
                            ...
                            <td class="text-center col-xs-4"
                                style="font-size: 20px;width: 200px; color: white; background-color: #64AEF7;">تكلفة
                                الليلة
                            </td>
                        </tr>
                        </thead>
                        ...
                        @foreach($allData as $value)
                            <tr>
                                <td><input type="radio" name="hotel" checked value="{{$value['hotelRoom_id']}}"></td>
                    ...
                    <div class="col-md-6 col-xs-12" style="float: right;">
                        <div style="font-size: 22px; font-weight: bold; color:#64AEF7;margin-right: 80px;">
                            <div class="form-group ">
                                ...
                                <input type="number" name="customers_count" min="1" max="500" class="form-control"
                                       id="usr"
                            ...
                            <button type="submit" class="btn btn-info"
                                    style="color: white; width: 100px;height: 40px; font-size: 20px;"><span
                                        class="glyphicon glyphicon-floppy-save" style="color:#f73917;"></span>&nbsp;حـذف
                            </button>
